<div id='janelaPrincipal' title='Cadastro de Tipo de Imóvel' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadTipoImovel' method='post'>
...
$(function(){
    ...
    var $dgLocal = $('#gridTipoImovel');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadTipoImovel/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadTipoImovel').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadTipoImovel/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadTipoImovel').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadTipoImovel').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadTipoImovel/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadTipoImovel').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadTipoImovel').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadTipoImovel/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadTipoImovel').submit();
    });
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadTipoImovel/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
