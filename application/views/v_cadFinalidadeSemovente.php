<div id='janelaPrincipal' title='Cadastro de Finalidade de Semoventes' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadFinalidadeSemovente' method='post'>
            ...
            <div id='gridFinalidadeSemovente'></div>
...
$(function(){
    ...
    var $dgLocal = $('#gridFinalidadeSemovente');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadFinalidadeSemovente/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadFinalidadeSemovente').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadFinalidadeSemovente/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadFinalidadeSemovente').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadFinalidadeSemovente').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadFinalidadeSemovente/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadFinalidadeSemovente').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadFinalidadeSemovente').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadFinalidadeSemovente/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadFinalidadeSemovente').submit();
    });
    ...
    function limparForm(){
        $('#frmCadFinalidadeSemovente').resetForm();
        $('#id').focus();
        desabilitaBotoes();
        idAnterior = null;
    };
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadFinalidadeSemovente/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
