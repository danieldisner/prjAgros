<div id='janelaPrincipal' title='Cadastro de Situação de Propriedade' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadSituacaoPropriedade' method='post'>
            ...
            <div id='gridSituacaoPropriedade'></div>
...
$(function(){
    ...
    var $dgLocal = $('#gridSituacaoPropriedade');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadSituacaoPropriedade/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadSituacaoPropriedade').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadSituacaoPropriedade/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadSituacaoPropriedade').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadSituacaoPropriedade').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadSituacaoPropriedade/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadSituacaoPropriedade').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadSituacaoPropriedade').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadSituacaoPropriedade/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadSituacaoPropriedade').submit();
    });
    ...
    function limparForm(){
        $('#frmCadSituacaoPropriedade').resetForm();
        $('#id').focus();
        desabilitaBotoes();
        idAnterior = null;
    };    
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadSituacaoPropriedade/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
