<div id='janelaPrincipal' title='Relatorio Processsos (Status Operações)' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmImpResumoCliente' method='post' action='<?php echo base_url('RelatorioProcessos/imprimir') ?>'>
            <div class='form-group'>
                ...
                <div class='row'>
                    ...
                    <div class='col-xs-2'>
                        <input type='text' class='form-control' id='cicloanoinicio' name='cicloanoinicio' placeholder='Ano'/>
                    </div>
                    <div class='col-xs-2'>
                        <input type='text' class='form-control' id='cicloanofim' name='cicloanofim' placeholder='Ano'/>
                    </div>
                </div>
            </div>
            <div class="groupBotoes">
                <input type='submit' id='btnImprimir' name='btnImprimir' class='btn btn-lg btn-default' value='Imprimir'/>
