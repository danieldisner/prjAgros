<div id='janelaPrincipal' title='Cadastro de Espécie de Móvel' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadEspecieMovel' method='post'>
...
$(function(){
    ...
    var $dgLocal = $('#gridEspecieMovel');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadEspecieMovel/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadEspecieMovel').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieMovel/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieMovel').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadEspecieMovel').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieMovel/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieMovel').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadEspecieMovel').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieMovel/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieMovel').submit();
    });
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadEspecieMovel/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
