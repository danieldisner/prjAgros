<div id='janelaPrincipal' title='Cadastro de Espécie de Imóvel' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadEspecieImovel' method='post'>
...
$(function(){
    ...
    var $dgLocal = $('#gridEspecieImovel');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadEspecieImovel/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadEspecieImovel').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieImovel/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieImovel').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadEspecieImovel').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieImovel/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieImovel').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadEspecieImovel').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadEspecieImovel/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadEspecieImovel').submit();
    });
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadEspecieImovel/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
