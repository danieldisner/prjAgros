<div id='janelaPrincipal' title='Cadastro de Raça' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadRaca' method='post'>
...
$(function(){
    ...
    var $dgLocal = $('#gridRaca');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadRaca/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadRaca').ajaxForm({
            ...
            url: '<?php echo base_url('CadRaca/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadRaca').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadRaca').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadRaca/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadRaca').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadRaca').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadRaca/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadRaca').submit();
    });
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadRaca/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
