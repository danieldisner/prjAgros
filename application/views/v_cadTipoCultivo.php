<div id='janelaPrincipal' title='Cadastro de Tipo de Cultivo' style='display: none'>
    <div class='form-dialog-ui'>
        <form id='frmCadTipoCultivo' method='post'>
...
$(function(){
    ...
    var $dgLocal = $('#gridTipoCultivo');
    function gridLoad(){
        $dgLocal.datagrid({
            jsonStore: {
                url:' <?php echo base_url('CadTipoCultivo/dadosGrid') ?>'
            },
            pagination: false,
            mapper:
            [
    ...
    $('#btnIncluir').click(function(){
        $('#frmCadTipoCultivo').ajaxForm({
            clearForm: true,
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadTipoCultivo/incluir') ?>',
            type:'post'
        }); 
        $('#frmCadTipoCultivo').submit();
    });
    ...
    $('#btnAlterar').click(function(){
        $('#frmCadTipoCultivo').ajaxForm({
            ...
            beforeSubmit: validaForm,
            success: showResponse,
            url: '<?php echo base_url('CadTipoCultivo/alterar') ?>',
            type:'post'
        }); 
        $('#frmCadTipoCultivo').submit();
    });
    ...
    $('#btnExcluir').click(function(){
        $('#frmCadTipoCultivo').ajaxForm({
            clearForm: true,
            success: showResponse,
            url: '<?php echo base_url('CadTipoCultivo/excluir') ?>',
            type:'post'
        }); 
        $('#frmCadTipoCultivo').submit();
    });
    ...
    function idBlur(){
        if(idAnterior !== $('#id').val()){
            $.post('<?php echo base_url('CadTipoCultivo/buscaRegistro') ?>',{
                id : $('#id').val()
            }, function(data){
                $('#nome').val(data.nome);
