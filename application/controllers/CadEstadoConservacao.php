...
class CadEstadoConservacao extends MY_Controller{
    ...
    public function index(){
        ...
        $dados['nome_view'] = 'v_cadEstadoConservacao';
    ...
    public function buscaRegistro(){
        ...
        // Busca o Registro
        $result = $this->modelEstadoConservacao->buscarRegistro($this->input->post('id'));
    ...
    public function incluir(){
        ...
        $this->load->model('M_EstadoConservacao', 'modelEstadoConservacao');
        // Insere os dados
        $this->modelEstadoConservacao->inserir($this->input->post());
        // Log de usuário
        $log = array(
    ...
    public function alterar(){
        ...
        // Insere os dados
        $this->modelEstadoConservacao->alterar($this->input->post('id'),$dados);    
        // Log de usuário
        $log = array(
          'empresa' => $this->session->userdata('empresa'),
          'usuario' => $this->session->userdata('usuario'),
    ...
    public function excluir(){
        ...
        $this->load->model('M_EstadoConservacao', 'modelEstadoConservacao');
        // Insere os dados
        $this->modelEstadoConservacao->excluir($this->input->post('id'));       
        // Log de usuário
        $log = array(
          'empresa' => $this->session->userdata('empresa'),
          'usuario' => $this->session->userdata('usuario'),
    ...
    public function dadosGrid(){
        ...
        $result = $this->modelEstadoConservacao->buscarDadosGrid(); 
