...
class CadTipoCultivo extends MY_Controller{
    ...
    public function index(){
        ...
        $dados['nome_view'] = 'v_cadTipoCultivo';
    ...
    public function buscaRegistro(){
        ...
        // Busca o Registro
        $result = $this->modelTipoCultivo->buscarRegistro($this->input->post('id'));
    ...
    public function incluir(){
        ...
        $this->load->model('M_TipoCultivo', 'modelTipoCultivo');
        // Insere os dados
        $this->modelTipoCultivo->inserir($this->input->post());
        // Log de usuário
        $log = array(
    ...
    public function alterar(){
        ...
        // Insere os dados
        $this->modelTipoCultivo->alterar($this->input->post('id'),$dados);     
        // Log de usuário
        $log = array(
          'empresa' => $this->session->userdata('empresa'),
          'usuario' => $this->session->userdata('usuario'),
    ...
    public function excluir(){
        ...
        $this->load->model('M_TipoCultivo', 'modelTipoCultivo');
        // Insere os dados
        $this->modelTipoCultivo->excluir($this->input->post('id')); 
        // Log de usuário
        $log = array(
          'empresa' => $this->session->userdata('empresa'),
          'usuario' => $this->session->userdata('usuario'),
    ...
    public function dadosGrid(){
        ...
        $result = $this->modelTipoCultivo->buscarDadosGrid(); 
